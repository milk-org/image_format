...
imageID IMAGE_FORMAT_FITS_to_ushortintbin_lock(const char *__restrict IDname, const char *__restrict fname);
...
errno_t FITS_to_ushortintbin_lock_addCLIcmd()
{
    ...
    RegisterCLIcommand("writeushortintlock", __FILE__, IMAGE_FORMAT_FITS_to_ushortintbin_lock_cli,
                       "write unsigned short int with file locking", "str1 is image, str2 is binary file",
